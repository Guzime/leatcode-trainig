...
class LinkedList4TaskTest {
    ...
    public void test2_1() {
        ...
        ListNode result = linkedList4Task.mergeTwoLists(node1_1, node1_2);
    ...
    public void test2_2() {
        ...
        ListNode result = linkedList4Task.mergeTwoLists2(node1_1, node2_1);
    ...
    public void test2_5() {
        ...
        ListNode result = linkedList4Task.mergeTwoLists2(node1_1, null);
        assertEquals("1", result.toString());
    }
    ...
    public void test2_7() {
        ...
        ListNode node1_2 = new ListNode(1);
        ListNode result = linkedList4Task.mergeTwoLists2(node1_1, node1_2);
        assertEquals("1,1", result.toString());
    }
